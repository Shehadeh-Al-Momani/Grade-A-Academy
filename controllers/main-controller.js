...
const { students_details, disable_user } = require('./adminRouter_controllers/students_controllers');
...
const { instructors_details, instructor_details } = require('./adminRouter_controllers/instructors_controllers');
const { addCategory } = require('./adminRouter_controllers/categories_controllers');
